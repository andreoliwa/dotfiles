...
BOOTCAMP_DISK_DEVICE=$(diskutil list | rg -e bootcamp -e osxfuse | rg -o disk.+)
...
sudo /usr/local/bin/ntfs-3g /dev/$BOOTCAMP_DISK_DEVICE /Volumes/WinHD -olocal -oallow_other
